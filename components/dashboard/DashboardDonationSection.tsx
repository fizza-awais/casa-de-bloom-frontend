      ...
      <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm font-medium leading-6 text-ui-text-muted">
            If you would like to support our community, registration gifts help
            cover event setup, refreshments, guest gifts, Kiwi Spa experiences,
            and future Casa de Bloom programs.
          </p>
        </div>
